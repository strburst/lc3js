...
function srcImmediateDecode(name) {
  return function(bits) {
    ...
    if (testBit(bits, 5)) {
      ...
      return {
        operation: name,
        destReg: exports.fetchBits(bits, 9, 11),
        srcReg1: exports.fetchBits(bits, 6, 8),
        immediate: exports.fetchBits(bits, 0, 4),
      };
    } else {
      // Register form
      return {
        ...
        destReg: exports.fetchBits(bits, 9, 11),
        srcReg1: exports.fetchBits(bits, 6, 8),
        srcReg2: exports.fetchBits(bits, 0, 2),
      };
    }
  };
}
...
function regOffsetDecode(name) {
  return function(bits) {
    var acc = {
      operation: name,
      register: exports.fetchBits(bits, 9, 11),
      offset: exports.fetchBits(bits, 0, 8),
    };
...
function baseOffsetDecode(name) {
  return function(bits) {
    return {
      operation: name,
      moveReg: exports.fetchBits(bits, 9, 11),
      baseReg: exports.fetchBits(bits, 6, 8),
      offset: exports.fetchBits(bits, 0, 5),
    };
  };
}
...
var bitDecoders = Object.freeze({
  ...
  'JMP': function(bits) {
    return {
      operation: 'JMP',
      register: exports.fetchBits(bits, 6, 8),
    };
  },
  'JSR': function(bits) {
    if (testBit(bits, 11)) {
      ...
      return {
        operation: 'JSR',
        offset: exports.fetchBits(bits, 0, 10),
      };
    } else {
      // Actually JSRR
      return {
  ...
  'NOT': function(bits) {
    return {
      operation: 'NOT',
      destReg: exports.fetchBits(bits, 9, 11),
      srcReg: exports.fetchBits(bits, 6, 8),
    };
  },
  // Omitted: RTI
